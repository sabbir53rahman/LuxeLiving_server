...
router.get("/assigned-properties", checkAuth("AGENT"), AgentController.getAssignedSellerProperties);
router.get("/earnings", checkAuth("AGENT"), AgentController.getAgentEarnings);
router.get("/analytics", checkAuth("AGENT"), AgentController.getAgentAnalytics);

...
-- CreateIndex
CREATE UNIQUE INDEX "schedules_mentorId_dayOfWeek_key" ON "schedules"("mentorId", "dayOfWeek");
...
-- AddForeignKey
ALTER TABLE "schedules" ADD CONSTRAINT "schedules_mentorId_fkey" FOREIGN KEY ("mentorId") REFERENCES "mentors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
